...
<template>
  <div class="wrapper">
    <div v-if="!image.isCropping" class="profile">
      <img :src="image.src ? image.src : image.placeHolder" />
      <button class="profile__plus" @click="$refs.file.click()">
    ...
    <div v-else class="cropper">
      <Cropper
        ...
        :src="image.src ? image.src : image.placeHolder"
        @change="change"
      />
